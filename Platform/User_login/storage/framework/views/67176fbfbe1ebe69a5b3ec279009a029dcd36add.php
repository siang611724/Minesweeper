...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <b><a class="navbar-brand" style="font-family: Arial; font-size: 1.25rem" href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(URL::asset('/image/icon.svg')); ?>" alt="profile Pic" height="30" width="30">
                        <?php echo e('Minesweeper Online'); ?>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <table class="d-xl-none d-lg-none">
                            <td style="margin-right: 20px" class="d-xl-none d-lg-none">
                                <tr>
                                    <td style="color: white;">信箱: <?php echo e(Auth::user()->email); ?> </td>
                                </tr>
                                <tr>
                                    <td style="color: white;">金幣: <?php echo e(Auth::user()->coins); ?><a href="#exampleModalCenter" class="fas fa-plus-circle" style="color: rgb(0, 157, 230)" data-toggle="modal" data-target="#exampleModalCenter"></a></td>
                                </tr>
                                <tr>
                                    <td>
        ...
        <script>
            ...
            function tradingList() {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'http://127.0.0.1:8000/api/trans/<?php echo e(Auth::id()); ?>',
                    dataType: 'json',
...
</html><?php /**PATH /Users/donuop/lab/Minesweeper/Platform/User_login/resources/views/layouts/app.blade.php ENDPATH**/ ?>