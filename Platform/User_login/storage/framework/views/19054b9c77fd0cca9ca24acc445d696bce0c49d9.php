...
<script type="text/javascript">
    ...
    //             $.ajax({
    //                 type: 'PUT',
    //                 url: 'http://127.0.0.1:8000/api/store/<?php echo e(Auth::id()); ?>',
    //                 dataType: 'json',
    //                 data: {
    //                     'coins': coinValue
    //                 },
    ...
    <div class="content row">
        <div class="information_left d-md-none d-lg-block d-sm-none d-none">
            ...
            <div style="height: 100px; width:100px; margin: 30px auto 5px">
                <img src="<?php echo e(URL::asset('/image/user_icon.jpg')); ?>" alt="profile Pic" height="100" width="100">
            </div> <!-- 頭像 -->
            <a class="" href="/edit">
                <p style="font-size:13px; padding-left: 88px; color: grey"><i class="fas fa-key"></i>變更密碼</p>
            </a>
            <p style="margin: 20px 20px auto">暱稱: <?php echo e(Auth::user()->name); ?></p>
            <p style="margin: 20px 20px auto">信箱: <?php echo e(Auth::user()->email); ?></p><p> </p>
        ...
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <!-- <form method="POST" action="api/store/<?php echo e(Auth::id()); ?>">
                        <?php echo csrf_field(); ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table class="table-sm table-striped" style="width: 100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $tradingRecord; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tRecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($tRecord->user_name); ?></td>
                                    <td><?php echo e($tRecord->trading_date); ?></td>
                                    <td><?php echo e($tRecord->trading_type); ?></td>
                                    <td><?php echo e($tRecord->trading_coins); ?></td>
                                    <td><?php echo e($tRecord->balance_coins); ?></td>
                                </tr>
...
<div class="modal fade" id="showHistoryLose" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                遊玩者:<div style="display:inline;"><?php echo e(Auth::user()->name); ?></div> <br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/donuop/lab/Minesweeper/Platform/User_login/resources/views/game.blade.php ENDPATH**/ ?>