    ...
    <div>
        <nav class="navbar navbar-dark bg-dark">
            <b><a class="navbar-brand" href="#">
                    <img src="<?php echo e(URL::asset('/image/icon.svg')); ?>" alt="profile Pic" width="30" height="30" class="d-inline-block align-top">
...
</html><?php /**PATH /Users/donuop/lab/Minesweeper/Platform/User_login/resources/views/admin.blade.php ENDPATH**/ ?>