...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <b><a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(URL::asset('/image/icon.svg')); ?>" alt="profile Pic" width="30" height="30">
...
$message = $__bag->first($__errorArgs[0]); ?>
                <span style="color: red; font-size: 14px"><?php echo e($errors->messages()['account'][0]); ?></span>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?> -->
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <?php if($errors->has('password') && !$errors->has('account')): ?>
...
</html><?php /**PATH /Users/donuop/lab/Minesweeper/Platform/User_login/resources/views/adminLogin.blade.php ENDPATH**/ ?>