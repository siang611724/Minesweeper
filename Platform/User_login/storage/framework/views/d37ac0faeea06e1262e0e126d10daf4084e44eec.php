...
<div class="container">
    <div class="content row">
        <div class="information_left d-md-none d-lg-block d-sm-none d-none">
            ...
            <p style="margin: 20px 20px auto">信箱: <?php echo e(Auth::user()->email); ?></p>
            <p style="margin: 20px 20px auto">金幣: <?php echo e(Auth::user()->coins); ?>
        ...
        <div class="gameArea_right col-lg-8 col-sm-12 col-12">
            ...
            <div class="right_collection">
                <form method="POST" action="/user/<?php echo e(Auth::id()); ?>" class="form-horizontal">
                    <?php echo csrf_field(); ?>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <span style="color: red; font-size: 14px"> <?php echo e($errors->messages()['oldPass'][0]); ?> </span>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($errors->has('newPass') && !$errors->has('oldPass')): ?>
                            <span style="color: red; font-size: 14px"> <?php echo e($errors->messages()['newPass'][0]); ?> </span>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/donuop/lab/Minesweeper/Platform/User_login/resources/views/user/edit.blade.php ENDPATH**/ ?>