...
<head>
  ...
  <style>
    ...
    .col-2 {
      padding: 3px;
      border-right: 1px solid LightStellBlue;
    }
...
<body>
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <b><a class="navbar-brand" href="#">
          <img src="./src/assets/icon.svg" width="30" height="30" class="d-inline-block align-top" alt="">
      ...
      <div class="row leftNav">
        ...
        <div class="col-10">
            ...
            <div class="tab-pane fade show active container" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td>
                        <button type="button" class="btn btn-primary btn-sm" onclick="ReadMore()">More</button>
                      </td>
                    </tr>
              ...
              <div id="Info">
                <div class="row">
                  ...
                  <div class="col-2 h1">
                    <button type="button" class="btn btn-danger" onclick=ban()>停權</button>
                    <button type="button" class="btn btn-success" onclick=release()>解除</button>
                  ...
                  <div class="nav w-100 nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">登入紀錄</a>
                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">金幣紀錄</a>
              ...
              <div class="accordion" id="accordionExample">
                ...
                <div class="card">
                  <div class="card-header" id="headingOne">
                    ...
                    <button class="btn btn-sm btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                      <span class="h5"></span> [修改]
                    </button>
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                      <div class="form-group">
                        <input type="text" placeholder="請輸入公告標題">
                        <button type="button" class="btn btn-danger float-right">取消</button>
                        <button type="button" class="btn btn-success  float-right mr-3">確認</button>
                      </div>
                      <textarea placeholder="請輸入公告內容"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-header" id="head2">
                    ...
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapse2">

                    </button>
                  </div>
                  <div id="collapseTwo" class="collapse" aria-labelledby="head2" data-parent="#accordionExample">
                    <div class="card-body">
                      <input type="text" placeholder="請輸入公告標題">
                      <br>
                      <br>
          ...
          <!-- <nav aria-label="Page navigation example">
            <ul class="pagination fixed-bottom justify-content-end">
              <li class="page-item">
  ...
  <script>
    ...
    //             $('<button type="button" class="btn btn-primary btn-sm" onclick="ReadMore(index)">', {
    //               text: "More"
    //             }, '</button></td>'),
    //           );
    //         });
